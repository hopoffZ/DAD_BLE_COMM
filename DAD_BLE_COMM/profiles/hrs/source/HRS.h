...
#include "BTTypes.h"            /* Bluetooth Type Definitions/Constants.      */
   ...
   /* Bluetooth Stack DAD Module is Initialized correctly.  This        */
   /* function *MUST* be called before ANY other Bluetooth Stack DAD    */
...
int InitializeDADModule(void);

   /* The following function is responsible for instructing the         */
   /* Bluetooth Stack DAD Module to clean up any resources that it has */
   /* allocated.  Once this function has completed, NO other Bluetooth  */
   /* Stack DAD Functions can be called until a successful call to the  */
   ...
   /* FALSE.                                                            */
void CleanupDADModule(Boolean_t ForceCleanup);
